    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-muted-foreground">
          Try the actions below and watch the event panel on the right update in real time.
        </p>
      </div>
      ...
      >
        ...
        <TabsContent value="events" className="mt-4">
          <Card>
            <CardHeader>
              <CardTitle>One-click events</CardTitle>
              <CardDescription>
                Simulate common user actions in a product
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="identity" className="mt-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Call PostHog identify to link anonymous users to a specific ID
              </CardDescription>
            </CardHeader>
